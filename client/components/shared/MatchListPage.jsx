...
const MatchListPage = ({ config }) => {
        ...
        return (
            <div className="bg-slate-100 min-h-screen relative">
                <div className="lg:mr-80 xl:mr-96">
                    <div className="px-4 py-4 min-[375px]:max-[390px]:px-8 min-[375px]:max-[390px]:py-8 sm:px-3 sm:py-3 md:p-4 min-[375px]:max-[390px]:pb-[calc(140px+env(safe-area-inset-bottom))]">
    ...
    return (
        <div className="bg-slate-100 min-h-screen relative">
            {/* Main content */}
            <div className="lg:mr-80 xl:mr-96">
                <div className="px-4 py-4 min-[375px]:max-[390px]:px-8 min-[375px]:max-[390px]:py-8 sm:px-3 sm:py-3 md:p-4 pb-[calc(1.25rem+env(safe-area-inset-bottom))] min-[375px]:max-[390px]:pb-[calc(140px+env(safe-area-inset-bottom))] md:pb-4">
                    {/* Header */}
